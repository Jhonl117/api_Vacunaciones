...
class server {
    constructor() {
        ...
        this.registrarFincasPath = '/api/registroFincas' //Ruta para la api usuario(Ruta pública)
        this.registrarVacunasPath = '/api/registroVacunacionAn' //Ruta para la api usuario(Ruta pública)
    ...
    routes() {
        this.app.use(this.registrarFincasPath, require('../routes/registroFincas'))
        this.app.use(this.registrarVacunasPath, require('../routes/registroVacunacionAn'))
    }
